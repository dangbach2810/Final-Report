        ...
        <>
            <Modal visible={isModalVisible} onOk={onOk} onCancel={handleCancel} >
                ...
                <div className='btn-checklist'>
                    ...
                    <button className='add-member-card' onClick={() => setIsShowMember(true)}>
                        +
                    </button>
                    {
                        isShowMember && (
                            <div className='list-member'>
                                ...
                                <div className='body-list'>
                                    ...
                                    {
                                        memberCard.length > 0 && memberCard.map((i, _i) => (
                                            <div className='body-list-member' key={_i} onClick={() => handlCardMember(i)}>
                                                <div className='member__item'>
                                                    <div className='item__avatar'>
                                                        <img src={!i.urlAvatar ? "https://anhdep123.com/wp-content/uploads/2020/11/anh-cute-hoat-hinh.jpg" : BASE_URL_IMAGE+"/"+i.urlAvatar}/>
                                                    </div>
